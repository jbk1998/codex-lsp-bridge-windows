...
- [x] Full `npm run ci:verify` passes after final edits (210 passed, 4
...
- [x] Coverage passes globally (83.56% statements, 75.26% branches, 90.67%
      functions, 87.28% lines) and for each focused high-risk module.
